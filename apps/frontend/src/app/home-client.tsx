        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <div className="space-y-1 pt-2">
              <p className="text-xs text-muted-foreground">Last transcript</p>
              <p className="rounded border bg-muted/30 p-2 text-xs">{lastTranscript || 'No transcript yet.'}</p>
            </div>

            <div className="space-y-1">
              <p className="text-xs text-muted-foreground">Last assistant text</p>
              <p className="rounded border bg-muted/30 p-2 text-xs">
                {lastAssistantText || 'No assistant response yet.'}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              {lastUtterance ? (
                ...
                <p className="rounded border bg-muted/30 p-2 text-xs">No utterance captured yet.</p>
              )}
            </div>

            <div className="space-y-1">
              <p className="text-xs text-muted-foreground">Last notice</p>
              <p className="rounded border bg-muted/30 p-2 text-xs">{lastNotice || '--'}</p>
            </div>

            <div className="space-y-1">
              <p className="text-xs text-muted-foreground">Last error</p>
              <p className="rounded border bg-muted/30 p-2 text-xs text-destructive">{lastError || '--'}</p>
            </div>
          </CardContent>
        </Card>
      </div>
